...
if (formData) {
    ...
    **/
    ...
    document.getElementById('appealsMessage').innerHTML = formatString(translations[language]["Text.AppealsMessage"], `<a href="/appeals-form">${translations[language]["Label.AppealsForm"]}</a>`);
